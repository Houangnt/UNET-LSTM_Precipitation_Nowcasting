...
class Attention(nn.Module):
    def __init__(self, input_dim, attention_dim):
        ...
        self.attention = nn.Sequential(
            ...
            nn.Conv2d(attention_dim, input_dim, kernel_size=1)  # Ensure output channels match input channels
        )
...
class RNN(nn.Module):
    def __init__(self, num_layers, num_hidden, configs):
        ...
        self.frame_channel = configs.channel  # This is now 3 for color images
        ...
        # attention mechanism
        self.attention = Attention(self.frame_channel, num_hidden[num_layers - 1] // 4)  # input_dim set to self.frame_channel
